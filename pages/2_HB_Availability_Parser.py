...
if hba_uploaded_file is not None:
    ...
    df_availability = pd.json_normalize(data, record_path=["hotels", "hotels", "rooms", "rates"]
                      ...
                      , errors="ignore")
    df_export = df[["hotels.hotels.code", "hotels.hotels.name", "hotels.hotels.rooms.code", "hotels.hotels.rooms.name", "hotels.hotels.currency", "net", "packaging", "rateType", "rateKey"]]
